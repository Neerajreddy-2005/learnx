...
import { Sheet, SheetContent, SheetTrigger } from "./ui/sheet"; // Updated import path
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/assessments" className="text-gray-600 hover:text-primary transition-colors">
              Assessments
            </Link>
            <div 
