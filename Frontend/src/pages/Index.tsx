...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Navbar onSearchClick={() => setIsSearchOpen(true)} isAuthenticated={false} />
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center animate-fade-down">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Bootcamp level quality, <span className="text-[#c3f53b]">at a fraction of the cost.</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Get the skills you need for a career in tech with hands-on learning and personal mentorship.
            </p>
            <Button 
              size="lg" 
              className="text-lg px-8 bg-[#c3f53b] text-[#141850] hover:bg-[#d4ff4d]"
